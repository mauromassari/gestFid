...
@Component({
  selector: 'app-modify-cliente-dialog',
  templateUrl: './modify-cliente-dialog.component.html',
  styleUrls: ['./modify-cliente-dialog.component.scss']
})
export class ModifyClienteDialogComponent implements OnInit {

  constructor(
    private dialogRef: MatDialogRef<ModifyClienteDialogComponent>,
  ...
  save() {
    ...
    this.dialogRef.close(this.clientiService.modCliente(this.cliente, this.cliente.id));
